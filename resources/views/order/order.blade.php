...
@section('styles')
    ...
    <style>
        ...
        .ring-brand-accent { --tw-ring-color: #eab308; }
    </style>
@endsection
                                ...
                                <div class="menu-item bg-brand-card rounded-lg border border-brand-accent/50 shadow-lg overflow-hidden transition-transform duration-300 hover:scale-[1.02]"
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="p-4 sm:p-6 flex flex-col justify-between w-2/3">
                                            ...
                                            <div class="mt-auto">
                                                {{-- Star rating can be made dynamic if you have a rating system --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="order-type" name="order_type" class="w-full bg-gray-900/50 border border-slate-600 rounded-md py-2 px-3 focus:ring-1 focus:ring-brand-accent focus:border-brand-accent transition">
                        ...
                        <div>
                            <label for="event-id" class="block text-sm font-medium text-slate-300 mb-1">Event ID (Optional)</label>
                            <input type="text" id="event-id" name="event_id" class="w-full bg-gray-900/50 border border-slate-600 rounded-md py-2 px-3 focus:ring-1 focus:ring-brand-accent focus:border-brand-accent transition" placeholder="e.g., BIRTHDAY24">
                        </div>
                        <div>
                            <label for="voucher-id" class="block text-sm font-medium text-slate-300 mb-1">Voucher ID</label>
                            <input type="text" id="voucher-id" name="voucher_id" class="w-full bg-gray-900/50 border border-slate-600 rounded-md py-2 px-3 focus:ring-1 focus:ring-brand-accent focus:border-brand-accent transition" placeholder="Enter voucher code">
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const formatCurrency = (number) => {
                ...
                }).format(number).replace(/\s*Rp/g, 'IDR '); // Handles different spacing
            };
            ...
            const updateOrder = () => {
                    ...
                    if (quantity > 0) {
                        ...
                        summaryHTML += `
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium">${formatCurrency(quantity * price)}</span>
                            </div>
                        `;

                        // Add hidden input for this item to be submitted with the form
                ...
                summaryList.innerHTML = summaryHTML || '<p class="text-slate-500 italic">Your cart is empty.</p>';
            };
